...
class synthetic_data():
    ...
    def node_weights(node_list, hub_list = [], hub_weight_list = []):
        ...
        return prob_list
        # TODO: there must be a smarter way to do this rather than tripling/quadrupligs/etc the list size.  come back later
...
class network():
    ...
    def __init__(self, network_name, network_json = default_network, cars_json = default_cars, runtime = 60):
        ...
        # read network_json and compile node list and edge list
        # TODO separate node and edge parts of input file
        for n in node_section:
